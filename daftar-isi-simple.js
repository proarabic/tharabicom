...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">موضوع ' + postTitle.length + ' متاح<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">متاح ' + numDisplayed + ' موضوع الان \'';
      tocNote += postFilter + '\' of '+ postTitle.length + ' مجموع المواضيع <br/></span>';
   }
